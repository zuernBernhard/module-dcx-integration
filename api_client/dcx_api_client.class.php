...
class DCX_Api_Client
{
    ...
    const HTTP_USERAGENT = 'DC-X Api Client (http://www.digicol.de/)';
    ...
    protected function getCurlHandle($url, $http_headers = false)
    {
        $curl = curl_init($url);
        ...
        curl_setopt($curl, CURLOPT_USERAGENT, self::HTTP_USERAGENT);
